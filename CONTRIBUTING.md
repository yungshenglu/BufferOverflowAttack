...
1. Fork this repository and clone the repository you forked
    ...
    $ git clone https://github.com/<YOUR_USERNAME>/BufferOverflowAttack
    # Navigate to the newly cloned directory
    $ cd BufferOverflowAttack
    ```
...
3. Assign the original repository to a remote called `upstream` and update
    ...
    $ git remote add upstream https://github.com/yungshenglu/BufferOverflowAttack
